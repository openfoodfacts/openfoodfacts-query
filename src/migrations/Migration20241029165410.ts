...
export class Migration20241029165410 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "query"."product" add column "process_id" bigint null;');
    this.addSql('create index "product_process_id_index" on "query"."product" ("process_id");');
  ...
  async down(): Promise<void> {
    this.addSql('alter table "query"."product" add column "last_update_id" uuid null;');
    this.addSql('create index "product_last_update_id_index" on "query"."product" ("last_update_id");');
