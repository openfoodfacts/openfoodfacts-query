...
export class Migration20240616125853 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create index "product_additives_tag_product_id_index" on "query"."product_additives_tag" ("product_id");');
    ...
    this.addSql('create index "product_allergens_tag_product_id_index" on "query"."product_allergens_tag" ("product_id");');
    ...
    this.addSql('create index "product_amino_acids_tag_product_id_index" on "query"."product_amino_acids_tag" ("product_id");');
    ...
    this.addSql('create index "product_brands_tag_product_id_index" on "query"."product_brands_tag" ("product_id");');
    ...
    this.addSql('create index "product_categories_properites_tag_product_id_index" on "query"."product_categories_properites_tag" ("product_id");');
    ...
    this.addSql('create index "product_categories_tag_product_id_index" on "query"."product_categories_tag" ("product_id");');
    ...
    this.addSql('create index "product_checkers_tag_product_id_index" on "query"."product_checkers_tag" ("product_id");');
    ...
    this.addSql('create index "product_cities_tag_product_id_index" on "query"."product_cities_tag" ("product_id");');
    ...
    this.addSql('create index "product_codes_tag_product_id_index" on "query"."product_codes_tag" ("product_id");');
    ...
    this.addSql('create index "product_correctors_tag_product_id_index" on "query"."product_correctors_tag" ("product_id");');
    ...
    this.addSql('create index "product_countries_tag_product_id_index" on "query"."product_countries_tag" ("product_id");');
    ...
    this.addSql('create index "product_data_quality_bugs_tag_product_id_index" on "query"."product_data_quality_bugs_tag" ("product_id");');
    ...
    this.addSql('create index "product_data_quality_errors_tag_product_id_index" on "query"."product_data_quality_errors_tag" ("product_id");');
    ...
    this.addSql('create index "product_data_quality_tag_product_id_index" on "query"."product_data_quality_tag" ("product_id");');
    ...
    this.addSql('create index "product_data_quality_warnings_tag_product_id_index" on "query"."product_data_quality_warnings_tag" ("product_id");');
    ...
    this.addSql('create index "product_data_sources_tag_product_id_index" on "query"."product_data_sources_tag" ("product_id");');
    ...
    this.addSql('create index "product_debug_tag_product_id_index" on "query"."product_debug_tag" ("product_id");');
    ...
    this.addSql('create index "product_ecoscore_tag_product_id_index" on "query"."product_ecoscore_tag" ("product_id");');
    ...
    this.addSql('create index "product_editors_tag_product_id_index" on "query"."product_editors_tag" ("product_id");');
    ...
    this.addSql('create index "product_emb_codes_tag_product_id_index" on "query"."product_emb_codes_tag" ("product_id");');
    ...
    this.addSql('create index "product_entry_dates_tag_product_id_index" on "query"."product_entry_dates_tag" ("product_id");');
    ...
    this.addSql('create index "product_food_groups_tag_product_id_index" on "query"."product_food_groups_tag" ("product_id");');
    ...
    this.addSql('create index "product_informers_tag_product_id_index" on "query"."product_informers_tag" ("product_id");');
    ...
    this.addSql('create index "product_ingredients_analysis_tag_product_id_index" on "query"."product_ingredients_analysis_tag" ("product_id");');
    ...
    this.addSql('create index "product_ingredients_from_palm_oil_tag_product_id_index" on "query"."product_ingredients_from_palm_oil_tag" ("product_id");');
    ...
    this.addSql('create index "product_ingredients_ntag_product_id_index" on "query"."product_ingredients_ntag" ("product_id");');
    ...
    this.addSql('create index "product_ingredients_original_tag_product_id_index" on "query"."product_ingredients_original_tag" ("product_id");');
    ...
    this.addSql('create index "product_ingredients_tag_product_id_index" on "query"."product_ingredients_tag" ("product_id");');
    ...
    this.addSql('create index "product_ingredients_that_may_be_from_palm_oil_tag_p_d0162_index" on "query"."product_ingredients_that_may_be_from_palm_oil_tag" ("product_id");');
    ...
    this.addSql('create index "product_keywords_tag_product_id_index" on "query"."product_keywords_tag" ("product_id");');
    ...
    this.addSql('create index "product_labels_tag_product_id_index" on "query"."product_labels_tag" ("product_id");');
    ...
    this.addSql('create index "product_languages_tag_product_id_index" on "query"."product_languages_tag" ("product_id");');
    ...
    this.addSql('create index "product_last_check_dates_tag_product_id_index" on "query"."product_last_check_dates_tag" ("product_id");');
    ...
    this.addSql('create index "product_last_edit_dates_tag_product_id_index" on "query"."product_last_edit_dates_tag" ("product_id");');
    ...
    this.addSql('create index "product_latest_image_dates_tag_product_id_index" on "query"."product_latest_image_dates_tag" ("product_id");');
    ...
    this.addSql('create index "product_manufacturing_places_tag_product_id_index" on "query"."product_manufacturing_places_tag" ("product_id");');
    ...
    this.addSql('create index "product_minerals_tag_product_id_index" on "query"."product_minerals_tag" ("product_id");');
    ...
    this.addSql('create index "product_misc_tag_product_id_index" on "query"."product_misc_tag" ("product_id");');
    ...
    this.addSql('create index "product_nova_groups_tag_product_id_index" on "query"."product_nova_groups_tag" ("product_id");');
    ...
    this.addSql('create index "product_nucleotides_tag_product_id_index" on "query"."product_nucleotides_tag" ("product_id");');
    ...
    this.addSql('create index "product_nutrient_levels_tag_product_id_index" on "query"."product_nutrient_levels_tag" ("product_id");');
    ...
    this.addSql('create index "product_nutriscore2021tag_product_id_index" on "query"."product_nutriscore2021tag" ("product_id");');
    ...
    this.addSql('create index "product_nutriscore2023tag_product_id_index" on "query"."product_nutriscore2023tag" ("product_id");');
    ...
    this.addSql('create index "product_nutriscore_tag_product_id_index" on "query"."product_nutriscore_tag" ("product_id");');
    ...
    this.addSql('create index "product_nutrition_grades_tag_product_id_index" on "query"."product_nutrition_grades_tag" ("product_id");');
    ...
    this.addSql('create index "product_origins_tag_product_id_index" on "query"."product_origins_tag" ("product_id");');
    ...
    this.addSql('create index "product_other_nutritional_substances_tag_product_id_index" on "query"."product_other_nutritional_substances_tag" ("product_id");');
    ...
    this.addSql('create index "product_packaging_materials_tag_product_id_index" on "query"."product_packaging_materials_tag" ("product_id");');
    ...
    this.addSql('create index "product_packaging_recycling_tag_product_id_index" on "query"."product_packaging_recycling_tag" ("product_id");');
    ...
    this.addSql('create index "product_packaging_shapes_tag_product_id_index" on "query"."product_packaging_shapes_tag" ("product_id");');
    ...
    this.addSql('create index "product_packaging_tag_product_id_index" on "query"."product_packaging_tag" ("product_id");');
    ...
    this.addSql('create index "product_periods_after_opening_tag_product_id_index" on "query"."product_periods_after_opening_tag" ("product_id");');
    ...
    this.addSql('create index "product_photographers_tag_product_id_index" on "query"."product_photographers_tag" ("product_id");');
    ...
    this.addSql('create index "product_pnns_groups1tag_product_id_index" on "query"."product_pnns_groups1tag" ("product_id");');
    ...
    this.addSql('create index "product_pnns_groups2tag_product_id_index" on "query"."product_pnns_groups2tag" ("product_id");');
    ...
    this.addSql('create index "product_popularity_tag_product_id_index" on "query"."product_popularity_tag" ("product_id");');
    ...
    this.addSql('create index "product_purchase_places_tag_product_id_index" on "query"."product_purchase_places_tag" ("product_id");');
    ...
    this.addSql('create index "product_states_tag_product_id_index" on "query"."product_states_tag" ("product_id");');
    ...
    this.addSql('create index "product_stores_tag_product_id_index" on "query"."product_stores_tag" ("product_id");');
    ...
    this.addSql('create index "product_teams_tag_product_id_index" on "query"."product_teams_tag" ("product_id");');
    ...
    this.addSql('create index "product_traces_tag_product_id_index" on "query"."product_traces_tag" ("product_id");');
    ...
    this.addSql('create index "product_unknown_nutrients_tag_product_id_index" on "query"."product_unknown_nutrients_tag" ("product_id");');
    ...
    this.addSql('create index "product_vitamins_tag_product_id_index" on "query"."product_vitamins_tag" ("product_id");');
    ...
    this.addSql('create index "product_weighers_tag_product_id_index" on "query"."product_weighers_tag" ("product_id");');
  ...
  async down(): Promise<void> {
    this.addSql('drop index "query"."product_additives_tag_product_id_index";');
    this.addSql('alter table "query"."product_additives_tag" drop constraint "product_additives_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_allergens_tag_product_id_index";');
    this.addSql('alter table "query"."product_allergens_tag" drop constraint "product_allergens_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_amino_acids_tag_product_id_index";');
    this.addSql('alter table "query"."product_amino_acids_tag" drop constraint "product_amino_acids_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_brands_tag_product_id_index";');
    this.addSql('alter table "query"."product_brands_tag" drop constraint "product_brands_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_categories_properites_tag_product_id_index";');
    this.addSql('alter table "query"."product_categories_properites_tag" drop constraint "product_categories_properites_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_categories_tag_product_id_index";');
    this.addSql('alter table "query"."product_categories_tag" drop constraint "product_categories_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_checkers_tag_product_id_index";');
    this.addSql('alter table "query"."product_checkers_tag" drop constraint "product_checkers_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_cities_tag_product_id_index";');
    this.addSql('alter table "query"."product_cities_tag" drop constraint "product_cities_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_codes_tag_product_id_index";');
    this.addSql('alter table "query"."product_codes_tag" drop constraint "product_codes_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_correctors_tag_product_id_index";');
    this.addSql('alter table "query"."product_correctors_tag" drop constraint "product_correctors_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_countries_tag_product_id_index";');
    this.addSql('alter table "query"."product_countries_tag" drop constraint "product_countries_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_data_quality_bugs_tag_product_id_index";');
    this.addSql('alter table "query"."product_data_quality_bugs_tag" drop constraint "product_data_quality_bugs_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_data_quality_errors_tag_product_id_index";');
    this.addSql('alter table "query"."product_data_quality_errors_tag" drop constraint "product_data_quality_errors_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_data_quality_tag_product_id_index";');
    this.addSql('alter table "query"."product_data_quality_tag" drop constraint "product_data_quality_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_data_quality_warnings_tag_product_id_index";');
    this.addSql('alter table "query"."product_data_quality_warnings_tag" drop constraint "product_data_quality_warnings_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_data_sources_tag_product_id_index";');
    this.addSql('alter table "query"."product_data_sources_tag" drop constraint "product_data_sources_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_debug_tag_product_id_index";');
    this.addSql('alter table "query"."product_debug_tag" drop constraint "product_debug_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_ecoscore_tag_product_id_index";');
    this.addSql('alter table "query"."product_ecoscore_tag" drop constraint "product_ecoscore_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_editors_tag_product_id_index";');
    this.addSql('alter table "query"."product_editors_tag" drop constraint "product_editors_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_emb_codes_tag_product_id_index";');
    this.addSql('alter table "query"."product_emb_codes_tag" drop constraint "product_emb_codes_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_entry_dates_tag_product_id_index";');
    this.addSql('alter table "query"."product_entry_dates_tag" drop constraint "product_entry_dates_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_food_groups_tag_product_id_index";');
    this.addSql('alter table "query"."product_food_groups_tag" drop constraint "product_food_groups_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_informers_tag_product_id_index";');
    this.addSql('alter table "query"."product_informers_tag" drop constraint "product_informers_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_ingredients_analysis_tag_product_id_index";');
    this.addSql('alter table "query"."product_ingredients_analysis_tag" drop constraint "product_ingredients_analysis_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_ingredients_from_palm_oil_tag_product_id_index";');
    this.addSql('alter table "query"."product_ingredients_from_palm_oil_tag" drop constraint "product_ingredients_from_palm_oil_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_ingredients_ntag_product_id_index";');
    this.addSql('alter table "query"."product_ingredients_ntag" drop constraint "product_ingredients_ntag_pkey";');
    ...
    this.addSql('drop index "query"."product_ingredients_original_tag_product_id_index";');
    this.addSql('alter table "query"."product_ingredients_original_tag" drop constraint "product_ingredients_original_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_ingredients_tag_product_id_index";');
    this.addSql('alter table "query"."product_ingredients_tag" drop constraint "product_ingredients_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_ingredients_that_may_be_from_palm_oil_tag_p_d0162_index";');
    this.addSql('alter table "query"."product_ingredients_that_may_be_from_palm_oil_tag" drop constraint "product_ingredients_that_may_be_from_palm_oil_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_keywords_tag_product_id_index";');
    this.addSql('alter table "query"."product_keywords_tag" drop constraint "product_keywords_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_labels_tag_product_id_index";');
    this.addSql('alter table "query"."product_labels_tag" drop constraint "product_labels_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_languages_tag_product_id_index";');
    this.addSql('alter table "query"."product_languages_tag" drop constraint "product_languages_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_last_check_dates_tag_product_id_index";');
    this.addSql('alter table "query"."product_last_check_dates_tag" drop constraint "product_last_check_dates_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_last_edit_dates_tag_product_id_index";');
    this.addSql('alter table "query"."product_last_edit_dates_tag" drop constraint "product_last_edit_dates_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_latest_image_dates_tag_product_id_index";');
    this.addSql('alter table "query"."product_latest_image_dates_tag" drop constraint "product_latest_image_dates_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_manufacturing_places_tag_product_id_index";');
    this.addSql('alter table "query"."product_manufacturing_places_tag" drop constraint "product_manufacturing_places_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_minerals_tag_product_id_index";');
    this.addSql('alter table "query"."product_minerals_tag" drop constraint "product_minerals_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_misc_tag_product_id_index";');
    this.addSql('alter table "query"."product_misc_tag" drop constraint "product_misc_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nova_groups_tag_product_id_index";');
    this.addSql('alter table "query"."product_nova_groups_tag" drop constraint "product_nova_groups_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nucleotides_tag_product_id_index";');
    this.addSql('alter table "query"."product_nucleotides_tag" drop constraint "product_nucleotides_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nutrient_levels_tag_product_id_index";');
    this.addSql('alter table "query"."product_nutrient_levels_tag" drop constraint "product_nutrient_levels_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nutriscore2021tag_product_id_index";');
    this.addSql('alter table "query"."product_nutriscore2021tag" drop constraint "product_nutriscore2021tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nutriscore2023tag_product_id_index";');
    this.addSql('alter table "query"."product_nutriscore2023tag" drop constraint "product_nutriscore2023tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nutriscore_tag_product_id_index";');
    this.addSql('alter table "query"."product_nutriscore_tag" drop constraint "product_nutriscore_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_nutrition_grades_tag_product_id_index";');
    this.addSql('alter table "query"."product_nutrition_grades_tag" drop constraint "product_nutrition_grades_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_origins_tag_product_id_index";');
    this.addSql('alter table "query"."product_origins_tag" drop constraint "product_origins_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_other_nutritional_substances_tag_product_id_index";');
    this.addSql('alter table "query"."product_other_nutritional_substances_tag" drop constraint "product_other_nutritional_substances_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_packaging_materials_tag_product_id_index";');
    this.addSql('alter table "query"."product_packaging_materials_tag" drop constraint "product_packaging_materials_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_packaging_recycling_tag_product_id_index";');
    this.addSql('alter table "query"."product_packaging_recycling_tag" drop constraint "product_packaging_recycling_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_packaging_shapes_tag_product_id_index";');
    this.addSql('alter table "query"."product_packaging_shapes_tag" drop constraint "product_packaging_shapes_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_packaging_tag_product_id_index";');
    this.addSql('alter table "query"."product_packaging_tag" drop constraint "product_packaging_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_periods_after_opening_tag_product_id_index";');
    this.addSql('alter table "query"."product_periods_after_opening_tag" drop constraint "product_periods_after_opening_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_photographers_tag_product_id_index";');
    this.addSql('alter table "query"."product_photographers_tag" drop constraint "product_photographers_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_pnns_groups1tag_product_id_index";');
    this.addSql('alter table "query"."product_pnns_groups1tag" drop constraint "product_pnns_groups1tag_pkey";');
    ...
    this.addSql('drop index "query"."product_pnns_groups2tag_product_id_index";');
    this.addSql('alter table "query"."product_pnns_groups2tag" drop constraint "product_pnns_groups2tag_pkey";');
    ...
    this.addSql('drop index "query"."product_popularity_tag_product_id_index";');
    this.addSql('alter table "query"."product_popularity_tag" drop constraint "product_popularity_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_purchase_places_tag_product_id_index";');
    this.addSql('alter table "query"."product_purchase_places_tag" drop constraint "product_purchase_places_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_states_tag_product_id_index";');
    this.addSql('alter table "query"."product_states_tag" drop constraint "product_states_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_stores_tag_product_id_index";');
    this.addSql('alter table "query"."product_stores_tag" drop constraint "product_stores_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_teams_tag_product_id_index";');
    this.addSql('alter table "query"."product_teams_tag" drop constraint "product_teams_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_traces_tag_product_id_index";');
    this.addSql('alter table "query"."product_traces_tag" drop constraint "product_traces_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_unknown_nutrients_tag_product_id_index";');
    this.addSql('alter table "query"."product_unknown_nutrients_tag" drop constraint "product_unknown_nutrients_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_vitamins_tag_product_id_index";');
    this.addSql('alter table "query"."product_vitamins_tag" drop constraint "product_vitamins_tag_pkey";');
    ...
    this.addSql('drop index "query"."product_weighers_tag_product_id_index";');
    this.addSql('alter table "query"."product_weighers_tag" drop constraint "product_weighers_tag_pkey";');
