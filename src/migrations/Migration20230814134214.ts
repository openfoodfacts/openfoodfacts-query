...
export class Migration20230814134214 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'alter table "query"."product_last_check_dates_tag" add constraint "product_last_check_dates_tag_product_id_foreign" foreign key ("product_id") references "query"."product" ("id") on update cascade;',
    );

    this.addSql(
      'alter table "query"."product_other_nutritional_substances_tag" add constraint "product_other_nutritional_substances_tag_product_id_foreign" foreign key ("product_id") references "query"."product" ("id") on update cascade;',
    );
  ...
  async down(): Promise<void> {
    this.addSql(
      'create table "query"."product_categories_properties_tag" ("product_id" uuid not null, "value" text not null, "obsolete" boolean not null default false, constraint "product_categories_properties_tag_pkey" primary key ("product_id", "value"));',
    );
    this.addSql(
    ...
    this.addSql(
      'create table "query"."product_data_quality_info_tag" ("product_id" uuid not null, "value" text not null, "obsolete" boolean not null default false, constraint "product_data_quality_info_tag_pkey" primary key ("product_id", "value"));',
    );
    this.addSql(
    ...
    this.addSql(
      'create table "query"."product_last_image_dates_tag" ("product_id" uuid not null, "value" text not null, "obsolete" boolean not null default false, constraint "product_last_image_dates_tag_pkey" primary key ("product_id", "value"));',
    );
    this.addSql(
    ...
    this.addSql(
      'create table "query"."product_quality_tag" ("product_id" uuid not null, "value" text not null, "obsolete" boolean not null default false, constraint "product_quality_tag_pkey" primary key ("product_id", "value"));',
    );
    this.addSql(
    ...
    this.addSql(
      'drop table if exists "query"."product_last_check_dates_tag" cascade;',
    );

    this.addSql(
      'drop table if exists "query"."product_other_nutritional_substances_tag" cascade;',
    );
  }
}
